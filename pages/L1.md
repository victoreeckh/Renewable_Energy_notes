...
- ### Why, when and where is it windy?
	...
	- Effect of altitude
		- Jet stream
			...
			- Waves
				- Trough
					- Dips down to lower altitudes -> Air masses forced together = region of convergence -> higher speed and lower pressure (in the jetstream)
					-
				- Ridge
					- Vice versa
					- Rises to higher altitudes -> region of divergence -> lower speed and higher pressure (in the stream)
	-