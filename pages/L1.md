	...
	- #### Surface
		- Irradiance on surface dependent on amount of scattering and absorption
			- Which is determined by:
				...
				- Hydrometers
		- Radiative transfer
			- Extinction coefficient (σλ):fractional loss of EM radiation due to gas scattering, gas absorption, particle scattering, or particle absorption per unit distance through the atmosphere.
			-